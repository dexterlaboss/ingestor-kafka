...
// type InputProtocol = TBinaryInputProtocol<thrift::transport::ReadHalf<TBufferChannel>>;
// type OutputProtocol = TBinaryOutputProtocol<thrift::transport::WriteHalf<TBufferChannel>>;
